...
const Section = () => {
    return (
        <section>
            <h3 hidden>Titulo de la seccion</h3>
...
const Gallery = () => {
    const titulos = ["1° Titulo", "2° Titulo", "3° Titulo", "4° Titulo", "5° Titulo", "6° Titulo", "7° Titulo"];
    return (
...
const App = () => {
    ...
    return (
        <div>
            ...
            {/* {edad >= 18 && (<p>Sos mayor de edad. Tenes {edad} años</p>)} */}

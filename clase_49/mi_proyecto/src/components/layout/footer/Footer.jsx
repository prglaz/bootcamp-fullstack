...
const Footer = () => {
    ...
    const socialMedias = [
        ...
        {
            id: 2, url: "/", icon: <Facebook
                width="40px"
                color="red" />, toolTip: "Facebook",
        },
    ...
    return (
        <Box
            ...
            <Box className="footer__groups">
                ...
                <Box>
                    ...
                    <Box className="footer__groups__list footer__groups__list--legal">
                        <Link href="https://drive.google.com/file/d/1akJ7-Vz7oUGU9z3PJenb056V5Q3pTiyA/">Términos y condiciones</Link>
                    </Box>
                </Box>
            ...
            <Box className="footer__copyright">
                <span><p>&copy;2023 Todos los derechos reservados</p></span>
            </Box>
